...
#define DBG(X)	printk(BIOS_DEBUG, "DEBUG%i\n",(X))
...
static void enable_emif_clocks_x(void)
{
...
static void ddr_pll_config_x(void)
{
 ...
 */
static void config_cmd_ctrl_x(void)
{
/*
 ...
 */
static void config_ddr_data_x_0(void)
{
/*
...
static void config_ddr_data_x_1(void)
{
/*
        writel(data->datardsratio0, &ddr_reg[macrono]->dt0rdsratio0);
        writel(data->datawdsratio0, &ddr_reg[macrono]->dt0wdsratio0);
...
static void config_io_ctrl_x(void)
{
/*
...
static void config_ddr_phy_x(void)
{
/*
...
static void set_sdram_timings_x(void)
{
/*
...
static void config_sdram_x(void)
{
#if 0
        if (regs->zq_config) {
                /*
